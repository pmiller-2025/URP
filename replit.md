...
- **Home Value in Net Worth**: Home value is included in net worth calculations (Home Value + Savings - Mortgage Balance) and displayed in tables without separate equity column
